...
const Footer = () => {
    ...
    const contactInfo = [
        ...
        { label: "Email", value: "info@tcsbv.com", href: "mailto:info@tcsbv.com" },
    ];
        ...
        >
            <div className="max-w-[1450px] mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-8 md:mb-12">
                    ...
                    >
                        <h3 className="text-2xl font-bold text-orange mb-4">TCsBV</h3>
                        <p className="text-cream/70 text-sm md:text-base leading-relaxed mb-4">
                            Highly skilled certified mechanics guaranteed. We strive for excellence in everything we do.
                        </p>
                    </motion.div>
                ...
                >
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-cream/60 text-sm text-center md:text-left">
                            © {new Date().getFullYear()} TCsBV. All rights reserved.
                        </p>
